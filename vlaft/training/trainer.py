...
class VLATrainer:
    ...
    def __init__(self, config: TrainingConfig):
        ...
        self.exp_dir = Path(config.output_dir) / f"{config.experiment_name}_{timestamp}"
        ...
        # Save config
        config.save(self.exp_dir / "config.yaml")
    ...
    def train(self):
        ...
        progress_bar = tqdm(total=total_steps, desc="Training", initial=self.global_step)
    ...
    def _load_checkpoint(self, checkpoint_path: str):
        ...
        if state_path.exists():
            ...
            logger.info(f"Resumed from checkpoint: step={self.global_step}, epoch={self.epoch}")
